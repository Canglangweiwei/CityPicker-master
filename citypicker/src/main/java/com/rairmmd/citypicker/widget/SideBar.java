package com.rairmmd.citypicker.widget;
...
import com.rairmmd.citypicker.R;
...
public class SideBar extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int textSize = RairUtils.dp2px(getContext(), 14);
        int normalColor = ContextCompat.getColor(getContext(), R.color.text);
